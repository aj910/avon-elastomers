...
const Shop = () => {
  ...
  useEffect(() => {
    ...
    async function fetchCategoryProducts() {
      try {
        setIsLoading(true);
        const response = await Axios.post(`/products?page=${pageNumber}`, { categoryIds, sortBy, attributeIds, search }, { cancelToken: productRequest.token });
  ...
  }, [categoryIds, sortBy, attributeIds, pageNumber, search]);
