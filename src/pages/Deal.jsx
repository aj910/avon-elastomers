...
const Deal = () => {
  ...
  useEffect(() => {
    ...
    async function fetchCategoryProducts() {
      try {
        setIsLoading(true);
        const response = await Axios.post(`/deal/${slug}?page=${pageNumber}`, { categoryIds, sortBy, attributeIds }, { cancelToken: productRequest.token });
  ...
  }, [slug, categoryIds, sortBy, attributeIds, pageNumber]);
